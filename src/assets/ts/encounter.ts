export const xpThreshold = [
  ...
  { level: 12, easy: 1000, medium: 2000, hard: 3000, deadly: 4000 },
  ...
  { level: 20, easy: 2800, medium: 5700, hard: 8500, deadly: 127000 },
];

export const multiplierTwo = [
  { monsters: 1, multiplier: 1.5 },
  { monsters: 2, multiplier: 2 },
  { monsters: 3, multiplier: 2.5 },
  { monsters: 4, multiplier: 2.5 },
  { monsters: 5, multiplier: 2.5 },
  { monsters: 6, multiplier: 2.5 },
  { monsters: 7, multiplier: 3 },
  { monsters: 8, multiplier: 3 },
  { monsters: 9, multiplier: 3 },
  { monsters: 10, multiplier: 3 },
  { monsters: 11, multiplier: 4 },
  { monsters: 12, multiplier: 4 },
  { monsters: 13, multiplier: 4 },
  { monsters: 14, multiplier: 4 },
  { monsters: 15, multiplier: 5 },
];

export const multiplerFive = [
...
export const multiplerSeven = [
  { monsters: 1, multiplier: 0.5 },
  { monsters: 2, multiplier: 1 },
  { monsters: 3, multiplier: 1.5 },
  { monsters: 4, multiplier: 1.5 },
  { monsters: 5, multiplier: 1.5 },
  { monsters: 6, multiplier: 1.5 },
  { monsters: 7, multiplier: 2 },
  { monsters: 8, multiplier: 2 },
  { monsters: 9, multiplier: 2 },
  { monsters: 10, multiplier: 2 },
  { monsters: 11, multiplier: 2.5 },
  { monsters: 12, multiplier: 2.5 },
  { monsters: 13, multiplier: 2.5 },
  { monsters: 14, multiplier: 2.5 },
  { monsters: 15, multiplier: 3 },
];
