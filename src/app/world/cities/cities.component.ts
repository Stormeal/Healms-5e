...
export class CitiesComponent implements OnInit {
  ...
  get population() {
    return this.cityForm.get("population");
  }
  get lord() {
    return this.cityForm.get("lord");
  }
  get description() {
      ...
      this.afs
        ...
        .subscribe(campaign => {
          ...
          if (this.selectedFiles) {
            ...
            // The storage path
            const path = `campaigns/${campId}/cities/${city.cityName}`;
              ...
              .pipe(
                finalize(() => {
                  ref.getDownloadURL().subscribe(url => {
                    ...
                    this.afs
                      .collection(`campaigns/${campId}/cities`)
                      .doc(cityId.uid)
                      .set(cityPhoto);
    ...
    this.auth.getUser().subscribe(user => {
      ...
      this.afs
        ...
        .subscribe(campaign => {
          ...
          this.afs
            .collection(`campaigns/${this.campaignId}/cities`)
            .valueChanges()
            .subscribe(cities => {
              this.cities = cities;
