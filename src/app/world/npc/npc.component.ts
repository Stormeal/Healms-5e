        ...
        this.auth.getUser().subscribe(user => {
            ...
            this.afs
                ...
                .subscribe(campaign => {
                    ...
                    this.afs
                        .collection(`campaigns/${this.campaignId}/npcs`)
                        .valueChanges()
                        .subscribe(creatures => {
                            this.npcs = creatures;
                            ...
                            .pipe(
                                finalize(() => {
                                    ref.getDownloadURL().subscribe(url => {
                                        ...
                                        const creaturePhoto = {
                                            uid: creatureId.uid,
                                            npcName: this.creatureForm.value["creatureName"],
                                            npcSize: this.creatureForm.value["creatureSize"],
                                            npcRace: this.creatureForm.value["creatureRace"],
                                            npcAlignment: this.creatureForm.value[
                                                "creatureAlignment"
                                            ],
                                            npcDescription: this.creatureForm.value["creatureDescription"],
                                        ...
                                        this.afs
                                            .collection(`campaigns/${campId}/npcs`)
                                            .doc(creature.uid)
                                            .set(creaturePhoto);
