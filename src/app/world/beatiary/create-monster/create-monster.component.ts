                ...
                finalize(() => {
                  ref.getDownloadURL().subscribe(url => {
                    ...
                    const creaturePhoto = {
                      ...
                      spellClass: this.creatureForm.value["spellClass"],
                      spellLevel: this.creatureForm.value["spellLevel"],
                      spellCantrip: this.creatureForm.value["cantrip"] || null,
                      spellFirst: this.creatureForm.value["first"] || null,
                      spellSecond: this.creatureForm.value["second"] || null,
                      spellThird: this.creatureForm.value["third"] || null,
                      spellFourth: this.creatureForm.value["fourth"] || null,
                      spellFifth: this.creatureForm.value["fifth"] || null,
                      spellSixth: this.creatureForm.value["sixth"] || null,
                      spellSeventh: this.creatureForm.value["seventh"] || null,
                      spellEight: this.creatureForm.value["eight"] || null,
                      spellNineth: this.creatureForm.value["nineth"] || null,
